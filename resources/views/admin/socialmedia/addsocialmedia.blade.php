...
<div class="content">
    <div class="container-fluid">
      ...
      <div class="col-md-6">
        <form role="form" action="{{route('submit-socialmedialink')}}" method="post" enctype="multipart/form-data">
            @csrf
          <div class="box-body">

            <div class="form-group">
              <label> Social Media Link<span class="dls">Name</span> </label>
              <input type="name" class="form-control" id="socialmedia_name" name="socialmedia_name" >
