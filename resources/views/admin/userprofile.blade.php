                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="business_name" class="form-control" placeholder="Bussniess" value="">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email_address" class="form-control" placeholder="Email" value="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
