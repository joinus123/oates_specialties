...
<div class="content">
    <div class="container-fluid">
      ...
      <div class="col-md-6">
        <form role="form" action="{{route('submitbrandlogo')}}" method="post" enctype="multipart/form-data">
            @csrf
          <div class="box-body">

            <div class="form-group">
              <label> Banner_slider <span class="dls">Logo Name</span> </label>
              <input type="name" class="form-control" id="brand_name" name="brand_name" >
