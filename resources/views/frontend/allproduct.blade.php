    ...
    <div class="banner">
        ...
        <div class="col-md-12">
            <div class="sub-page-heading">
                <div class="container">
                    <h2><?php echo isset($Category_id) ? $Category_id[0]['category_name'] . '--' .
                        count($product) : 'All products'; ?></h2>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="product-list list-hover">
                    ...
                    @foreach ($Categorys as $Category)
                        <ul>
                            <li><a href="{{ route('productcategory', [$Category->id]) }}">{{ $Category->category_name }}
                                    <span></span></a></li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <li>
                                                        <button type="submit" class="add_to_cart_btn"
                                                            title="add to cart" data-tip="Add to Cart">
